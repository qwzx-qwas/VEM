...
> pnpm-lock.yaml SHA-256: `db372376e8c0e33f71b662d1a4e4b787a1f3e0d966341372e2d5d2d5cf81fafb`
> Package records: 235; license expressions: Apache-2.0, BSD-2-Clause, BSD-3-Clause, BlueOak-1.0.0, ISC, MIT, MPL-2.0
...
| `@oxc-parser/binding-linux-x64-gnu` | `0.142.0` | `MIT` | https://oxc.rs/docs/guide/usage/parser |
...
| `@vitejs/plugin-react` | `6.0.4` | `MIT` | https://github.com/vitejs/vite-plugin-react/tree/main/packages/plugin-react#readme |
...
| `buffer-image-size` | `0.6.4` | `MIT` | https://github.com/evidentpoint/buffer-image-size#readme |
...
| `happy-dom` | `20.11.1` | `MIT` | https://github.com/capricorn86/happy-dom |
...
| `magic-string` | `1.1.0` | `MIT` | https://github.com/Rich-Harris/magic-string#readme |
...
| `oxc-parser` | `0.142.0` | `MIT` | https://oxc.rs/docs/guide/usage/parser |
